/**
 * Standalone build config for the dsh-aliyun plugin.
 *
 ...
 * __ModuleLoader__, served at /plugins/aliyun/client.js).
 */
import { clientBundle } from './shared/tsdown.client.ts'

export default clientBundle('dsh-aliyun', ['src/index.ts'], {
  libExternal: [
